...
<div class="author-pane">
 <div class="author-pane-inner">
    ...
    <div class="author-pane-section author-pane-general">
      ...
      <?php if (is_array($profile) && !empty($profile['Персональные данные']['profile_country']['#value']) && !empty($profile['Персональные данные']['profile_city']['#value'])): ?>
        <div class="author-pane-place"><?php print $profile['Персональные данные']['profile_country']['#value']; ?> - <?php print $profile['Персональные данные']['profile_city']['#value']; ?></div>
      <?php endif; ?>
