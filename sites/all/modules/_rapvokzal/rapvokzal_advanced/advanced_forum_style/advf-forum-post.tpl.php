      ...
      <?php endif; ?>
        ...
        <?php
          if ($top_post) {
            ...
            print '<noindex><div class="yashare-auto-init" data-yashareType="button" data-yashareQuickServices="yaru,vkontakte,facebook,twitter,odnoklassniki,moimir,lj,blogger"></div></noindex>';
          }
        ?>
